...
public class FuelSim {
     ...
     */
    public void launchFuel(LinearVelocity launchVelocity, Angle hoodAngle, Angle turretYaw, Translation3d shooterRelativeToRobotTranslation) {
        ...
        Pose3d launchPose = new Pose3d(this.robotPoseSupplier.get())
                .plus(new Transform3d(shooterRelativeToRobotTranslation, Rotation3d.kZero));
